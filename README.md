...
<a href="https://pascal.fihm.co.uk"><img alt="PASCal" src="https://img.shields.io/badge/try-PASCal-navy?style=flat&color=navy&cacheSeconds=3600&link=https%3A%2F%2Fpascal.fihm.co.uk"></a>
...
It is written entirely in Python, using plotly to visualise the data, and is also available without installation as a web tool, available at [pascal.fihm.co.uk](https://pascal.fihm.co.uk).
